...
### Освобождение памяти, когда она больше не нужна {#Освобождение_памяти_когда_она_более_не_нужна}
...
#### Теперь циклические ссылки - не проблема {#Теперь_циклические_ссылки_-_не_проблема}
...
#### Ограничение: некоторые объекты нуждаются в явном признаке недоступности {#Ограничение_некоторые_объекты_нуждаются_в_явном_признаке_недоступности}
